...
async function drawAll() {
    ...
    if(!start && confirmed && mosesImagesLoaded && allIsraeliteImagesLoaded && allEgyptianImagesLoaded && !loading) {
        ...
        printText(canvas.width / 3.51, canvas.height / 2 , 28, 'white', (mobileVersion ? 'tap here to continue' : 'press space to start')); // on arcade machines, it will read 'insert coin to start'
