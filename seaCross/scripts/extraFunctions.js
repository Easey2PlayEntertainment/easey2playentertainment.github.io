...
function touchStart(e) {
    ...
    if(e.touches.length === 1) {
        ...
        if(!start /*&& showPreviousHighScores /*&& !initialCollect*/) {
            ...
            } else if(e.touches[0].clientY < window.outerHeight / 2) {
...
function dealWithCrabs() {
    if(start && !loading) {
        if(questionNumber % 4 === 0 && !bonusShellCaught && crabs.length !== crabOutput && crabs.length < 4 && questionNumber > 0 && !crabOutputIncrement && !powerupRun && crabs.length !== 10) {
            if(crabs.length !== 4) {
                crabs.push(new Crab());    
            }    
