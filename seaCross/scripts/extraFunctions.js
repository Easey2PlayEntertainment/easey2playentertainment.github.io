...
function manageBackgroundMusic() {
    ...
    if(!powerupArriveCalled && powerupBeingUsed && !powerupArriveInterrupted && !win && !newLevelReachedPlayed && (!bonusLevel && !bonusLevelAnnounced || bonusLevel && bonusLevelAnnounced) && (backgroundScoreEstablished || bonusLevelBackgroundEstablished)) {
